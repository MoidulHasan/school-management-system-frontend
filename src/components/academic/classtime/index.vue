<template>
    ...
    <div>
        <div class="col-12">
            <div class="card">
                <h5>Class Time Slot Data Table</h5>
                <DataTable :value="tableData" :paginator="true" class="p-datatable-gridlines" :rows="10" dataKey="id"
                    ...
                    :filters="filters" responsiveLayout="scroll" :globalFilterFields="['startTime', 'endTime']">
                    ...
                    <Column field="startTime" header="Class Start Time" filterField="data.startTime"
