        ...
        <div
            ...
            <router-link to="/" class="flex align-items-center">
                <img src="layout/images/Kushdi Khan Bari kindergarten.svg" alt="Kushdi Khan Bari kindergarten"
                    height="50" class="mr-0 lg:mr-2">Kushdi Khan Bari kindergarten<span
                    class="text-900 font-medium text-2xl line-height-3 mr-8"></span>
            </router-link>
            <a class="cursor-pointer block lg:hidden text-700 p-ripple" v-ripple
                v-styleclass="{ selector: '@next', enterClass: 'hidden', leaveToClass: 'hidden', hideOnOutsideClick: true }">
                <i class="pi pi-bars text-4xl"></i>
            </a>
            <div class="surface-0 align-items-center flex-grow-1 justify-content-between hidden lg:flex absolute lg:static w-full left-0 px-6 lg:px-0 z-2"
                style="top:92%">
                <ul
                ...
                <div class="col-12 mt-8 mb-8 p-2 md:p-8"
                    ...
                    <div
                        ...
                        <p class="text-gray-900 sm:line-height-2 md:line-height-4 text-2xl mt-4"
                            style="max-width:800px;">“Duis aute irure dolor in reprehenderit in voluptate velit esse
            ...
            <div class="grid justify-content-between">
                <div class="col-12 md:col-2" style="margin-top:-1.5rem;">
                    <div
                        ...
                        <img :src="'layout/images/logo-' + logoColor + '.svg'" alt="footer sections" width="50"
